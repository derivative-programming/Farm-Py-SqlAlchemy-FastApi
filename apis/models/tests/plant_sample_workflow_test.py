# apis/models/tests/plant_sample_workflow_test.py  # pylint: disable=duplicate-code # noqa: E501
...
from ...models.plant_sample_workflow import (
    PlantSampleWorkflowPostModelResponse,
    PlantSampleWorkflowPostModelRequest)
from ..factory.plant_sample_workflow import (
...
class TestPlantSampleWorkflowPostModelRequest:
    """
    This class contains unit tests for the
    PlantSampleWorkflowPostModelRequest class.
    """
...
class TestPlantSampleWorkflowPostModelResponse:
    ...
    async def test_flow_process_request(self, session):
        ...
        async def mock_process(
            ...
            return FlowPlantSampleWorkflowResult()
        with patch.object(
            FlowPlantSampleWorkflow,
            'process',
