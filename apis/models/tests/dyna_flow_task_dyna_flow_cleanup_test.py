# apis/models/tests/dyna_flow_task_dyna_flow_cleanup_test.py  # pylint: disable=duplicate-code # noqa: E501
...
from ...models.dyna_flow_task_dyna_flow_cleanup import (
    DynaFlowTaskDynaFlowCleanupPostModelResponse,
    DynaFlowTaskDynaFlowCleanupPostModelRequest)
from ..factory.dyna_flow_task_dyna_flow_cleanup import (
...
class TestDynaFlowTaskDynaFlowCleanupPostModelRequest:
    """
    This class contains unit tests for the
    DynaFlowTaskDynaFlowCleanupPostModelRequest class.
    """
...
class TestDynaFlowTaskDynaFlowCleanupPostModelResponse:
    ...
    async def test_flow_process_request(self, session):
        ...
        async def mock_process(
            ...
            return FlowDynaFlowTaskDynaFlowCleanupResult()
        with patch.object(
            FlowDynaFlowTaskDynaFlowCleanup,
            'process',
