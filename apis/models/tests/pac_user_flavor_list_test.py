# apis/models/tests/pac_user_flavor_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class MockReportItemPacUserFlavorList:  # pylint: disable=too-few-public-methods
    """
