# apis/models/tests/pac_user_land_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class MockReportItemPacUserLandList:  # pylint: disable=too-few-public-methods
    """
