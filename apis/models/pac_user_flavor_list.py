# apis/models/pac_user_flavor_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class PacUserFlavorListGetModelResponse(
    ListModel
):
    """
