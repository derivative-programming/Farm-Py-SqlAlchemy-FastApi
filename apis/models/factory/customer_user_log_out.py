# apis/models/factory/customer_user_log_out.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import
"""
Factory module for creating instances of
CustomerUserLogOutPostModelRequest with
...
class CustomerUserLogOutPostModelRequestFactory(
    ...
    async def create_async(
        ...
        obj = CustomerUserLogOutPostModelRequestFactory \
            .build(
