# apis/models/process_all_dyna_flow_type_schedule_task.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module contains the models for the
Process All Dyna Flow Type Schedule Task API.
"""
...
class ProcessAllDynaFlowTypeScheduleTaskPostModelRequest(CamelModel):
    """
...
class ProcessAllDynaFlowTypeScheduleTaskPostModelResponse(PostResponse):
    """
    ...
    def load_flow_response(
            self, data: FlowProcessAllDynaFlowTypeScheduleTaskResult):
        """
