# apis/models/init/pac_user_land_list_init_report.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module contains the models and request/response classes
for the PacUserLandListInitReport workflow.
"""
...
from flows.pac_user_land_list_init_report import (
...
class PacUserLandListInitReportGetInitModelResponse(
    CamelModel
):
    """
    ...
    def load_flow_response(
        ...
        FlowPacUserLandListInitReportResult object.
        """
...
class PacUserLandListInitReportGetInitModelRequest(
    SnakeModel
):
    """
    ...
    async def process_request(
        ...
        try:
            ...
            flow = FlowPacUserLandListInitReport(
                session_context)
            logging.info(
                "process request..."
                "PacUserLandListInitReport"
