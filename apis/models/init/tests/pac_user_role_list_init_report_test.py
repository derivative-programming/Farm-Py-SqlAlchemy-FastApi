# apis/models/init/tests/pac_user_role_list_init_report_test.py  # pylint: disable=duplicate-code
...
class MockFlowPacUserRoleListInitReportResult:  # pylint: disable=too-few-public-methods
    """
