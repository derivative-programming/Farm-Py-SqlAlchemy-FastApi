# apis/models/init/tests/land_plant_list_init_report_test.py  # pylint: disable=duplicate-code
...
class MockFlowLandPlantListInitReportResult:  # pylint: disable=too-few-public-methods
    """
