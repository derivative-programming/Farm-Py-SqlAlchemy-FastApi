# apis/models/init/tests/customer_user_log_out_init_obj_wf_test.py  # pylint: disable=duplicate-code
...
class MockFlowCustomerUserLogOutInitObjWFResult:  # pylint: disable=too-few-public-methods
    """
