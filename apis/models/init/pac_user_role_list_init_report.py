# apis/models/init/pac_user_role_list_init_report.py  # pylint: disable=duplicate-code # noqa: E501
...
class PacUserRoleListInitReportGetInitModelResponse(
    CamelModel
):
    """
...
class PacUserRoleListInitReportGetInitModelRequest(
    SnakeModel
):
    """
    ...
    async def process_request(
        ...
        try:
            ...
            flow = FlowPacUserRoleListInitReport(
                session_context)
            logging.info(
                "process request..."
                "PacUserRoleListInitReport"
