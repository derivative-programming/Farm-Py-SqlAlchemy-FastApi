# apis/models/init/pac_user_date_greater_than_filter_list_init_report.py  # pylint: disable=duplicate-code # noqa: E501
...
class PacUserDateGreaterThanFilterListInitReportGetInitModelResponse(
    CamelModel
):
    """
...
class PacUserDateGreaterThanFilterListInitReportGetInitModelRequest(
    SnakeModel
):
    """
