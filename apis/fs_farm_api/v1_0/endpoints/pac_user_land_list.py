...
class PacUserLandListRouter(BaseRouter):
    ...
    @staticmethod
    @router.get("/api/v1_0/pac-user-land-list/{pac_code}/init",
    ...
    @staticmethod
    @router.get("/api/v1_0/pac-user-land-list/{pac_code}",
    ...
    @staticmethod
    @router.get("/api/v1_0/pac-user-land-list/{pac_code}/to-csv",
