# apis/fs_farm_api/v1_0/endpoints/pac_user_land_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class PacUserLandListRouterConfig():  # pylint: disable=too-few-public-methods
    """
    ...
    async def request_get_init(
        ...
        async with session:
            try:
                ...
                logging.info(
                    "PacUserLandListRouter.request_get_init"
