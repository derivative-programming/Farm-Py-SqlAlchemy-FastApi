# apis/fs_farm_api/v1_0/endpoints/tac_register.py  # pylint: disable=duplicate-code # noqa: E501
...
class TacRegisterRouterConfig():  # pylint: disable=too-few-public-methods
    """
