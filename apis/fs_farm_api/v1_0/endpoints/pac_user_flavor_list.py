...
class PacUserFlavorListRouter(BaseRouter):
    ...
    @staticmethod
    @router.get("/api/v1_0/pac-user-flavor-list/{pac_code}/init",
    ...
    @staticmethod
    @router.get("/api/v1_0/pac-user-flavor-list/{pac_code}",
    ...
    @staticmethod
    @router.get("/api/v1_0/pac-user-flavor-list/{pac_code}/to-csv",
