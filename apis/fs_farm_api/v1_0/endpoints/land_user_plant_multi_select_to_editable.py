# apis/fs_farm_api/v1_0/endpoints/land_user_plant_multi_select_to_editable.py  # pylint: disable=duplicate-code # noqa: E501
...
class LandUserPlantMultiSelectToEditableRouterConfig():  # pylint: disable=too-few-public-methods
    """
