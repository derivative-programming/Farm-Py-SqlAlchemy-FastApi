# apis/fs_farm_api/v1_0/endpoints/tests/pac_user_tri_state_filter_list_test.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import, too-many-public-methods

"""
This module contains unit tests for the
`pac_user_tri_state_filter_list` endpoint.
"""
...
async def test_init_success(
    ...
    async with AsyncClient(
        ...
        response = await ac.get(
            "/api/v1_0/pac-user-tri-state-filter-list"
            f"/{pac_code}/init",
...
async def test_get_success(
    ...
    `pac_user_tri_state_filter_list` get endpoint.
    """
...
async def test_get_authorization_failure_no_header(
    ...
    '/api/v1_0/pac-user-tri-state-filter-list/{pac_code}' endpoint
...
async def test_get_csv_authorization_failure_bad_api_key(
    ...
    2. Create a PacUserTriStateFilterListGetModelRequest using
        the PacUserTriStateFilterListGetModelRequestFactory.
...
async def test_get_csv_authorization_failure_empty_header_key(
    ...
    Steps:
    1. Create a test pac using the PacFactory.
    2. Create a PacUserTriStateFilterListGetModelRequest
