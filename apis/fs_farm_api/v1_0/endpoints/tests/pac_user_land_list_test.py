# apis/fs_farm_api/v1_0/endpoints/tests/pac_user_land_list_test.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import, too-many-public-methods

"""
This module contains unit tests for the
`pac_user_land_list` endpoint.
"""
...
async def test_get_success(
    ...
    `pac_user_land_list` get endpoint.
    """
...
async def test_get_csv_authorization_failure_empty_header_key(
    ...
    Steps:
    1. Create a test pac using the PacFactory.
    2. Create a PacUserLandListGetModelRequest
    ...
    If the PacUserLandListRouterConfig.is_public is True:
    - The response status code should be 200.
    - The response content type should start with the test_constants.
        REPORT_TO_CSV_MEDIA_TYPE.

    If the PacUserLandListRouterConfig.is_public is False:
...
async def test_get_csv_endpoint_url_failure(
    ...
    This test case verifies that the API endpoint
        '/api/v1_0/pac-user-land-list/{pac_code}/to-csv/xxx'
