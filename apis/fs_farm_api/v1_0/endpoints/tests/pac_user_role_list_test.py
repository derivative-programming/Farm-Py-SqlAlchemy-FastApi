# apis/fs_farm_api/v1_0/endpoints/tests/pac_user_role_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
async def test_init_success(
    ...
    pac = await \
        model_factorys.PacFactory.create_async(
            overridden_get_db)
    pac_code = pac.code
...
async def test_get_csv_authorization_failure_empty_header_key(
    ...
    Steps:
    1. Create a test pac using the PacFactory.
    2. Create a PacUserRoleListGetModelRequest
...
async def test_get_csv_endpoint_invalid_code_failure(
    ...
    '/api/v1_0/pac-user-role-list/{pac_code}/to-csv'
    endpoint when an invalid pac code is provided.
