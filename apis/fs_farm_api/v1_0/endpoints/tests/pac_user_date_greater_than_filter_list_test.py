# apis/fs_farm_api/v1_0/endpoints/tests/pac_user_date_greater_than_filter_list_test.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import, too-many-public-methods

"""
This module contains unit tests for the
`pac_user_date_greater_than_filter_list` endpoint.
"""
...
async def test_get_success(
    ...
    `pac_user_date_greater_than_filter_list` get endpoint.
    """
...
async def test_get_csv_authorization_failure_empty_header_key(
    ...
    Steps:
    1. Create a test pac using the PacFactory.
    2. Create a PacUserDateGreaterThanFilterListGetModelRequest
...
async def test_get_csv_authorization_failure_no_header(
    ...
    PacUserDateGreaterThanFilterListRouterConfig is True:
    - The response status code should be 200.
    - The response content type should start with the
        'REPORT_TO_CSV_MEDIA_TYPE' defined in the test_constants.

    If the 'is_public' flag in the
    PacUserDateGreaterThanFilterListRouterConfig is False:
    - The response status code should be 401.
