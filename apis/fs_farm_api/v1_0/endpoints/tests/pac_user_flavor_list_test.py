# apis/fs_farm_api/v1_0/endpoints/tests/pac_user_flavor_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
async def test_get_authorization_failure_no_header(
    ...
    '/api/v1_0/pac-user-flavor-list/{pac_code}' endpoint
...
async def test_get_csv_authorization_failure_bad_api_key(
    ...
    2. Create a PacUserFlavorListGetModelRequest using
        the PacUserFlavorListGetModelRequestFactory.
...
async def test_get_csv_authorization_failure_empty_header_key(
    ...
    Steps:
    1. Create a test pac using the PacFactory.
    2. Create a PacUserFlavorListGetModelRequest
