# reports/tests/pac_user_role_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestReportManagerPacUserRoleList:
    ...
    `ReportManagerPacUserRoleList` class.
    """
...
# endset  # noqa: E122
        ...
        with patch.object(
            ...
            report_generator = ReportManagerPacUserRoleList(
                session_context)
...
# endset  # noqa: E122
    ...
    async def test_build_csv(self, session):
        ...
        session_context = SessionContext(
            {}, session)
        test_obj = ReportManagerPacUserRoleList(
            session_context)
        test_data = [ReportItemPacUserRoleList(),
                     ReportItemPacUserRoleList()]
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacUserRoleList
                       ) for item in result
        )
