# reports/tests/pac_user_tri_state_filter_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class in the
`pac_user_tri_state_filter_list` module.
"""
...
class TestReportManagerPacUserTriStateFilterList:
    ...
    `ReportManagerPacUserTriStateFilterList` class.
    """
...
# endset  # noqa: E122
        ...
        with patch.object(
            ...
            report_generator = ReportManagerPacUserTriStateFilterList(
                session_context)
...
# endset  # noqa: E122
    ...
    async def test_build_csv(self, session):
        ...
        session_context = SessionContext(
            {}, session)
        test_obj = ReportManagerPacUserTriStateFilterList(
            session_context)
        test_data = [ReportItemPacUserTriStateFilterList(),
                     ReportItemPacUserTriStateFilterList()]
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacUserTriStateFilterList
                       ) for item in result
        )
