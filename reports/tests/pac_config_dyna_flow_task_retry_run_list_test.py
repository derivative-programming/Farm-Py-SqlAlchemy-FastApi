# reports/tests/pac_config_dyna_flow_task_retry_run_list_test.py  # pylint: disable=duplicate-code
...
class in the
`pac_config_dyna_flow_task_retry_run_list` module.
"""
...
from reports.pac_config_dyna_flow_task_retry_run_list import ReportManagerPacConfigDynaFlowTaskRetryRunList
from reports.providers.pac_config_dyna_flow_task_retry_run_list import ReportProviderPacConfigDynaFlowTaskRetryRunList
from reports.report_request_validation_error import \
    ReportRequestValidationError
from reports.row_models.pac_config_dyna_flow_task_retry_run_list import ReportItemPacConfigDynaFlowTaskRetryRunList

# Register the adapter
sqlite3.register_adapter(Decimal, str)


class TestReportManagerPacConfigDynaFlowTaskRetryRunList:
    """
    This class contains unit tests for the
    `ReportManagerPacConfigDynaFlowTaskRetryRunList` class.
    """
...
# endset  # noqa: E122
        ...
        with patch.object(
            ...
            report_generator = ReportManagerPacConfigDynaFlowTaskRetryRunList(
                session_context)
...
# endset  # noqa: E122
    ...
    async def test_build_csv(self, session):
        ...
        session_context = SessionContext(
            {}, session)
        test_obj = ReportManagerPacConfigDynaFlowTaskRetryRunList(
            session_context)
        test_data = [ReportItemPacConfigDynaFlowTaskRetryRunList(),
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacConfigDynaFlowTaskRetryRunList
                       ) for item in result
        )
    ...
    def test_parse_bool(self, session):
        ...
        in the ReportManagerPacConfigDynaFlowTaskRetryRunList class.
