# pac_config_dyna_flow_task_search_test.py
...
class in the
`pac_config_dyna_flow_task_search` module.
"""
...
class TestReportManagerPacConfigDynaFlowTaskSearch:
    """
    This class contains unit tests for the
    `ReportManagerPacConfigDynaFlowTaskSearch` class.
    """
...
# endset  # noqa: E122
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacConfigDynaFlowTaskSearch
                       ) for item in result
        )
    ...
    def test_parse_bool(self, session):
        ...
        in the ReportManagerPacConfigDynaFlowTaskSearch class.
