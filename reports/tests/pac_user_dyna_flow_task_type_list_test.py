# reports/tests/pac_user_dyna_flow_task_type_list_test.py  # pylint: disable=duplicate-code
...
class in the
`pac_user_dyna_flow_task_type_list` module.
"""
...
from reports.pac_user_dyna_flow_task_type_list import ReportManagerPacUserDynaFlowTaskTypeList
from reports.providers.pac_user_dyna_flow_task_type_list import ReportProviderPacUserDynaFlowTaskTypeList
from reports.report_request_validation_error import \
    ReportRequestValidationError
from reports.row_models.pac_user_dyna_flow_task_type_list import ReportItemPacUserDynaFlowTaskTypeList

# Register the adapter
sqlite3.register_adapter(Decimal, str)


class TestReportManagerPacUserDynaFlowTaskTypeList:
    """
    This class contains unit tests for the
    `ReportManagerPacUserDynaFlowTaskTypeList` class.
    """
...
# endset  # noqa: E122
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacUserDynaFlowTaskTypeList
                       ) for item in result
        )
    ...
    def test_parse_bool(self, session):
        ...
        in the ReportManagerPacUserDynaFlowTaskTypeList class.
