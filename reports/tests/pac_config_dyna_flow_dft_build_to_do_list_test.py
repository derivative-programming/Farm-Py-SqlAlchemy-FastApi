...
class in the
`pac_config_dyna_flow_dft_build_to_do_list` module.
"""
...
class TestReportManagerPacConfigDynaFlowDFTBuildToDoList:
    """
    This class contains unit tests for the
    `ReportManagerPacConfigDynaFlowDFTBuildToDoList` class.
    """
...
# endset  # noqa: E122
        ...
        with patch.object(
            ...
            report_generator = ReportManagerPacConfigDynaFlowDFTBuildToDoList(
                session_context)
...
# endset  # noqa: E122
    ...
    async def test_build_csv(self, session):
        ...
        session_context = SessionContext(
            {}, session)
        test_obj = ReportManagerPacConfigDynaFlowDFTBuildToDoList(
            session_context)
        test_data = [ReportItemPacConfigDynaFlowDFTBuildToDoList(),
                     ReportItemPacConfigDynaFlowDFTBuildToDoList()]
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacConfigDynaFlowDFTBuildToDoList
                       ) for item in result
        )
    ...
    def test_parse_bool(self, session):
        ...
        in the ReportManagerPacConfigDynaFlowDFTBuildToDoList class.
