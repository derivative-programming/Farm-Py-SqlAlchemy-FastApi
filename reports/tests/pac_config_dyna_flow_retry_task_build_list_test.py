...
class in the
`pac_config_dyna_flow_retry_task_build_list` module.
"""
...
class TestReportManagerPacConfigDynaFlowRetryTaskBuildList:
    """
    This class contains unit tests for the
    `ReportManagerPacConfigDynaFlowRetryTaskBuildList` class.
    """
...
# endset  # noqa: E122
        ...
        with patch.object(
            ...
            report_generator = ReportManagerPacConfigDynaFlowRetryTaskBuildList(
                session_context)
...
# endset  # noqa: E122
    ...
    async def test_build_csv(self, session):
        ...
        session_context = SessionContext(
            {}, session)
        test_obj = ReportManagerPacConfigDynaFlowRetryTaskBuildList(
            session_context)
        test_data = [ReportItemPacConfigDynaFlowRetryTaskBuildList(),
                     ReportItemPacConfigDynaFlowRetryTaskBuildList()]
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacConfigDynaFlowRetryTaskBuildList
                       ) for item in result
        )
    ...
    def test_parse_bool(self, session):
        ...
        in the ReportManagerPacConfigDynaFlowRetryTaskBuildList class.
