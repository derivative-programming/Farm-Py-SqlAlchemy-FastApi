# reports/tests/pac_user_date_greater_than_filter_list_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestReportManagerPacUserDateGreaterThanFilterList:
    ...
    `ReportManagerPacUserDateGreaterThanFilterList` class.
    """
...
# endset  # noqa: E122
        ...
        with patch.object(
            ...
            report_generator = ReportManagerPacUserDateGreaterThanFilterList(
                session_context)
...
# endset  # noqa: E122
    ...
    async def test_build_csv(self, session):
        ...
        session_context = SessionContext(
            {}, session)
        test_obj = ReportManagerPacUserDateGreaterThanFilterList(
            session_context)
        test_data = [ReportItemPacUserDateGreaterThanFilterList(),
                     ReportItemPacUserDateGreaterThanFilterList()]
    ...
    async def test_read_csv(self, session):
        ...
        assert all(
            isinstance(item, ReportItemPacUserDateGreaterThanFilterList
                       ) for item in result
        )
