# reports/pac_config_dyna_flow_task_run_to_do_list.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module is the manager for report
'Pac Config Dyna Flow Task Run To Do List'
"""
...
class ReportManagerPacConfigDynaFlowTaskRunToDoList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacConfigDynaFlowTaskRunToDoList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        """
        Generate the
        'Pac Config Dyna Flow Task Run To Do List' report.

        Returns:
            List[ReportItemPacConfigDynaFlowTaskRunToDoList]: The
                list of report items.
        """
        logging.info("ReportManagerPacConfigDynaFlowTaskRunToDoList"
                     ".generate"
                     " Start")
        ...
        provider = ReportProviderPacConfigDynaFlowTaskRunToDoList(
...
# endset  # noqa: E122
    ...
    async def build_csv(
        self,
        file_name: str,
        data_list: List[ReportItemPacConfigDynaFlowTaskRunToDoList]
    ):
        """
        ...
        with open(file_name, mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(
                file,
                fieldnames=vars(
                    ReportItemPacConfigDynaFlowTaskRunToDoList()).keys(),
    ...
    async def read_csv(
        ...
        with open(file_name, mode='r', newline='', encoding='utf-8') as file:
            ...
            for row in reader:
                obj = ReportItemPacConfigDynaFlowTaskRunToDoList()
