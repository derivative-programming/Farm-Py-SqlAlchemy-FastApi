# reports/pac_user_dyna_flow_task_type_list.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module is the manager for report
'Pac User Dyna Flow Task Type List'
"""
...
class ReportManagerPacUserDynaFlowTaskTypeList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacUserDynaFlowTaskTypeList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        """
        Generate the
        'Pac User Dyna Flow Task Type List' report.

        Returns:
            List[ReportItemPacUserDynaFlowTaskTypeList]: The
                list of report items.
        """
        logging.info("ReportManagerPacUserDynaFlowTaskTypeList"
                     ".generate"
                     " Start")
        ...
        provider = ReportProviderPacUserDynaFlowTaskTypeList(
...
# endset  # noqa: E122
    ...
    async def build_csv(
        self,
        file_name: str,
        data_list: List[ReportItemPacUserDynaFlowTaskTypeList]
    ):
        """
        ...
        with open(file_name, mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(
                file,
                fieldnames=vars(
                    ReportItemPacUserDynaFlowTaskTypeList()).keys(),
    ...
    async def read_csv(
        ...
        with open(file_name, mode='r', newline='', encoding='utf-8') as file:
            ...
            for row in reader:
                obj = ReportItemPacUserDynaFlowTaskTypeList()
