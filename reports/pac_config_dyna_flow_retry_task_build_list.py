# reports/pac_config_dyna_flow_retry_task_build_list.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module is the manager for report
'Pac Config Dyna Flow Retry Task Build List'
"""
...
class ReportManagerPacConfigDynaFlowRetryTaskBuildList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacConfigDynaFlowRetryTaskBuildList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        """
        Generate the
        'Pac Config Dyna Flow Retry Task Build List' report.

        Returns:
            List[ReportItemPacConfigDynaFlowRetryTaskBuildList]: The
                list of report items.
        """
        logging.info("ReportManagerPacConfigDynaFlowRetryTaskBuildList"
                     ".generate"
                     " Start")
        ...
        provider = ReportProviderPacConfigDynaFlowRetryTaskBuildList(
...
# endset  # noqa: E122
    ...
    async def build_csv(
        self,
        file_name: str,
        data_list: List[ReportItemPacConfigDynaFlowRetryTaskBuildList]
    ):
        """
        ...
        with open(file_name, mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(
                file,
                fieldnames=vars(
                    ReportItemPacConfigDynaFlowRetryTaskBuildList()).keys(),
    ...
    async def read_csv(
        ...
        with open(file_name, mode='r', newline='', encoding='utf-8') as file:
            ...
            for row in reader:
                obj = ReportItemPacConfigDynaFlowRetryTaskBuildList()
