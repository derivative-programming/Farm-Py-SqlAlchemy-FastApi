# reports/pac_config_dyna_flow_task_retry_run_list.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module is the manager for report
'Pac Config Dyna Flow Task Retry Run List'
"""
...
class ReportManagerPacConfigDynaFlowTaskRetryRunList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacConfigDynaFlowTaskRetryRunList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        """
        Generate the
        'Pac Config Dyna Flow Task Retry Run List' report.

        Returns:
            List[ReportItemPacConfigDynaFlowTaskRetryRunList]: The
                list of report items.
        """
        logging.info("ReportManagerPacConfigDynaFlowTaskRetryRunList"
                     ".generate"
                     " Start")
        ...
        provider = ReportProviderPacConfigDynaFlowTaskRetryRunList(
...
# endset  # noqa: E122
    ...
    async def build_csv(
        self,
        file_name: str,
        data_list: List[ReportItemPacConfigDynaFlowTaskRetryRunList]
    ):
        """
        ...
        with open(file_name, mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(
                file,
                fieldnames=vars(
                    ReportItemPacConfigDynaFlowTaskRetryRunList()).keys(),
    ...
    async def read_csv(
        ...
        with open(file_name, mode='r', newline='', encoding='utf-8') as file:
            ...
            for row in reader:
                obj = ReportItemPacConfigDynaFlowTaskRetryRunList()
