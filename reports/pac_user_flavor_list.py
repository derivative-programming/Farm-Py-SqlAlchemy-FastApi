# reports/pac_user_flavor_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportManagerPacUserFlavorList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacUserFlavorList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        provider = ReportProviderPacUserFlavorList(
    ...
    async def build_csv(
        ...
        with open(file_name, mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(
                file,
                fieldnames=vars(
                    ReportItemPacUserFlavorList()).keys(),
