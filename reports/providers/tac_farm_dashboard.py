# reports/providers/tac_farm_dashboard.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportProviderTacFarmDashboard():
    """
    The ReportProviderTacFarmDashboard
    ...
    async def generate_list(
        ...
        """
        Generates a list of tac s based
        on the provided parameters.

        Returns:
            list[dict[str, Any]]: The list of
            tac s as dictionaries.
        """
        flow_name = (
        ...
        cursor = await self._session_context.session.execute(
            text(ReportProviderTacFarmDashboard
                 ._cached_sql_query),
            query_dict
        )
