...
of tac s based on the provided parameters.
"""
import json
...
class ReportProviderTacFarmDashboard():
    """
    The ReportProviderTacFarmDashboard class is responsible
    for generating a list of tac s
    ...
    def __init__(self, session_context: SessionContext):
        """
        Initializes a new instance of the ReportProviderTacFarmDashboard class.
        Args:
            session_context (SessionContext): The session context object.
        Raises:
            ValueError: If the session is not provided.
    ...
    async def generate_list(
        ...
        """
        Generates a list of tac s based on the provided parameters.
        Returns:
            list[dict[str, Any]]: The list of tac s as dictionaries.
        """
        ...
        if ReportProviderTacFarmDashboard._cached_sql_query == "":
