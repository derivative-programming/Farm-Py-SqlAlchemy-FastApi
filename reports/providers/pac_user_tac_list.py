...
class ReportProviderPacUserTacList():
		...
		async def generate_list(
			...
			logging.info("ReportProviderPacUserTacList.generate_list Start")
			logging.info("ReportProviderPacUserTacList.generate_list context_code:" + str(context_code))
			...
			file_path = "reports/providers/sql/pac_user_tac_list.gen.sql"
			...
			logging.info("ReportProviderPacUserTacList.generate_list Results: " + json.dumps(results))
			logging.info("ReportProviderPacUserTacList.generate_list End")
			return results
