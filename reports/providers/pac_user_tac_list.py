# reports/providers/pac_user_tac_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportProviderPacUserTacList():
    ...
    async def generate_list(
        ...
        if ReportProviderPacUserTacList \
                ._cached_sql_query == "":
        ...
        cursor = await self._session_context.session.execute(
            text(ReportProviderPacUserTacList
                 ._cached_sql_query),
            query_dict
        )
