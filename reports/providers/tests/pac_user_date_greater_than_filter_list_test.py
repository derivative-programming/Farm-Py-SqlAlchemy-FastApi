# reports/providers/tests/pac_user_date_greater_than_filter_list_test.py  # pylint: disable=duplicate-code
...
class TestReportProviderPacUserDateGreaterThanFilterList:  # pylint: disable=too-few-public-methods
    """
    ...
    async def test_report_creation(self, session):
        ...
        report_provider = ReportProviderPacUserDateGreaterThanFilterList(
            session_context)
