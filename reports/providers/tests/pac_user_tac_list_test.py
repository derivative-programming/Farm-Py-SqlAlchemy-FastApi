# reports/providers/tests/pac_user_tac_list_test.py  # pylint: disable=duplicate-code
...
class TestReportProviderPacUserTacList:  # pylint: disable=too-few-public-methods
    """
    ...
    async def test_report_creation(self, session):
        ...
        report_provider = ReportProviderPacUserTacList(
            session_context)
