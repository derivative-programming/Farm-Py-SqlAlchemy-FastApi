# reports/providers/tests/land_plant_list_test.py  # pylint: disable=duplicate-code
...
class TestReportProviderLandPlantList:  # pylint: disable=too-few-public-methods
    """
