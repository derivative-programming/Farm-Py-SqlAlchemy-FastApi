# reports/providers/tests/pac_user_role_list_test.py  # pylint: disable=duplicate-code
...
class TestReportProviderPacUserRoleList:  # pylint: disable=too-few-public-methods
    """
