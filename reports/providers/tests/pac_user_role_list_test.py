...
# class ReportProviderPacUserRoleListTest(TestCase):
#     def setUp(self):
#         CurrentRuntime.initialize()
#         session_context = SessionContext(dict())
#         self.report_provider = ReportProviderPacUserRoleList(session_context)
...
#             self.assertIn("role_code", result)
#             self.assertIn("role_description", result)
#             self.assertIn("role_display_order", result)
#             self.assertIn("role_is_active", result)
#             self.assertIn("role_lookup_enum_name", result)
#             self.assertIn("role_name", result)
#             self.assertIn("pac_name", result)
#             # self.assertEqual(result["field_one_role_list_link_pac_code"], str(self.pacCode).replace('-', ''))
