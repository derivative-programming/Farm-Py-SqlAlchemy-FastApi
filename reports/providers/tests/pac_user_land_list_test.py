# reports/providers/tests/pac_user_land_list_test.py  # pylint: disable=duplicate-code
...
class TestReportProviderPacUserLandList:  # pylint: disable=too-few-public-methods
    """
