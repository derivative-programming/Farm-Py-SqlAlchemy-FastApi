# reports/providers/pac_user_flavor_list.py  # pylint: disable=duplicate-code # noqa: E501
...
of pac flavors based on the provided parameters.
"""
...
class ReportProviderPacUserFlavorList():
    """
    The ReportProviderPacUserFlavorList
    class is responsible
    for generating a list of pac flavors
    ...
    async def generate_list(
        ...
        if ReportProviderPacUserFlavorList \
                ._cached_sql_query == "":
        ...
        cursor = await self._session_context.session.execute(
            text(ReportProviderPacUserFlavorList
                 ._cached_sql_query),
            query_dict
        )
