	...
	(
		...
		where
			...
			and (
				...
				:is_started_tri_state_filter_code = REPLACE('00000000-0000-0000-0000-000000000000', '-', '') or
				(
					(
						select
							state_int_value
						...
						where code = REPLACE(:is_started_tri_state_filter_code, '-', '')
					) in (
					-1,
			...
			and (
				...
				:is_completed_tri_state_filter_code = REPLACE('00000000-0000-0000-0000-000000000000', '-', '') or
				(
					(
						select
							state_int_value
						from
							farm_tri_state_filter
						where code = REPLACE(:is_completed_tri_state_filter_code, '-', '')
					) in (
					-1,
			...
			and (
				...
				:is_successful_tri_state_filter_code = REPLACE('00000000-0000-0000-0000-000000000000', '-', '') or
				(
					(
						select
							state_int_value
						from
							farm_tri_state_filter
						where code = REPLACE(:is_successful_tri_state_filter_code, '-', '')
					) in (
					-1,
