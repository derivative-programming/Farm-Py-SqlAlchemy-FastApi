# reports/providers/pac_user_dyna_flow_type_list.py  # pylint: disable=duplicate-code # noqa: E501
...
of pac dyna_flow_types based on the provided parameters.
"""
...
class ReportProviderPacUserDynaFlowTypeList():
    """
    The ReportProviderPacUserDynaFlowTypeList
    class is responsible
    for generating a list of pac dyna_flow_types
    ...
    async def generate_list(
        ...
        """
        Generates a list of pac dyna_flow_types based
        on the provided parameters.

        Returns:
            list[dict[str, Any]]: The list of
            pac dyna_flow_types as dictionaries.
        """
        flow_name = (
        ...
        if ReportProviderPacUserDynaFlowTypeList \
                ._cached_sql_query == "":
            ...
            if 'postgresql' in db_engine_url:
                sql_folder = "postgres"
            # Prioritize
            # 'pac_user_dyna_flow_type_list.inc.sql'
            # if it exists
            inc_file_path = (
            ...
            gen_file_path = (
                f"reports/providers/sql/{sql_folder}/"
                "pac_user_dyna_flow_type_list.gen.sql"
            )
        ...
        cursor = await self._session_context.session.execute(
            text(ReportProviderPacUserDynaFlowTypeList
                 ._cached_sql_query),
            query_dict
        )
