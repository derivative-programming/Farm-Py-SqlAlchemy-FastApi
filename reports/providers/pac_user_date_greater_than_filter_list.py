# reports/providers/pac_user_date_greater_than_filter_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportProviderPacUserDateGreaterThanFilterList():
    ...
    async def generate_list(
        ...
        """
        Generates a list of pac date_greater_than_filters based
