# reports/providers/pac_user_land_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportProviderPacUserLandList():
    ...
    async def generate_list(
        ...
        if ReportProviderPacUserLandList \
                ._cached_sql_query == "":
        ...
        cursor = await self._session_context.session.execute(
            text(ReportProviderPacUserLandList
                 ._cached_sql_query),
            query_dict
        )
