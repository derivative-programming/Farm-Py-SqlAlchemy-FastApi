# reports/providers/pac_user_role_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportProviderPacUserRoleList():
    ...
    async def generate_list(
        ...
        if ReportProviderPacUserRoleList \
                ._cached_sql_query == "":
        ...
        cursor = await self._session_context.session.execute(
            text(ReportProviderPacUserRoleList
                 ._cached_sql_query),
            query_dict
        )
