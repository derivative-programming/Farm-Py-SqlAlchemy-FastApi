# reports/pac_user_tac_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportManagerPacUserTacList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacUserTacList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        """
        logging.info("ReportManagerPacUserTacList"
                     ".generate"
                     " Start")
