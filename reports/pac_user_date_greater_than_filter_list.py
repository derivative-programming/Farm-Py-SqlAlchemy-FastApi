# reports/pac_user_date_greater_than_filter_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportManagerPacUserDateGreaterThanFilterList(ReportManagerBase):
    """
