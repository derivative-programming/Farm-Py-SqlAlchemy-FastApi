# reports/pac_user_role_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportManagerPacUserRoleList(ReportManagerBase):
    """
    ...
    def __init__(self, session_context: SessionContext):
        ...
        if session_context.session is None:
            raise TypeError(
                "ReportManagerPacUserRoleList.init"
                " session_context has "
                "no session assigned"
            )
...
# endset  # noqa: E122
        ...
        provider = ReportProviderPacUserRoleList(
    ...
    async def build_csv(
        ...
        with open(file_name, mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(
                file,
                fieldnames=vars(
                    ReportItemPacUserRoleList()).keys(),
