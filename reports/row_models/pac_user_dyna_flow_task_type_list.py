# reports/row_models/pac_user_dyna_flow_task_type_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportItemPacUserDynaFlowTaskTypeList():  # pylint: disable=too-few-public-methods
    """
