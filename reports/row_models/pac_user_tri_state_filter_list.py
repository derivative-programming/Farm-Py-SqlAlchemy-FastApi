# reports/row_models/pac_user_tri_state_filter_list.py  # pylint: disable=duplicate-code # noqa: E501
...
class ReportItemPacUserTriStateFilterList():  # pylint: disable=too-few-public-methods
    """
