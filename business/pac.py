...
# endset
    ...
    async def load_from_id(
        ...
        :raises ValueError: If pac_id is not an integer or
            if no pac data is found.
        """
    ...
    async def load_from_dict(
        ...
        :raises ValueError: If pac_dict is not a
            dictionary or if no pac data is found.
        """
