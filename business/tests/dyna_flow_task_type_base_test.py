# business/tests/dyna_flow_task_type_base_test.py  # pylint: disable=duplicate-code # noqa: E501
...
import pytest
from business.dyna_flow_task_type_base import DynaFlowTaskTypeBaseBusObj
...
BUSINESS_DYNA_FLOW_TASK_TYPE_BASE_MANAGER_PATCH = (
    "business.dyna_flow_task_type_base"
...
def mock_sess_base_bus_obj(
    mock_session_context, dyna_flow_task_type
):
    """
    Fixture that returns a
    DynaFlowTaskTypeBaseBusObj instance.
    """
    mock_sess_base_bus_obj = DynaFlowTaskTypeBaseBusObj(
        mock_session_context)
    mock_sess_base_bus_obj.dyna_flow_task_type = \
        dyna_flow_task_type
    return mock_sess_base_bus_obj


class TestDynaFlowTaskTypeBaseBusObj:
    """
    Unit tests for the
    DynaFlowTaskTypeBusObj class.
    """
    ...
    @pytest.mark.asyncio
    async def test_create_dyna_flow_task_type(
        self,
        new_bus_obj: DynaFlowTaskTypeBusObj
    ):
        """
        Test case for creating a new dyna_flow_task_type.
        """
        # Test creating a new dyna_flow_task_type

        assert new_bus_obj.dyna_flow_task_type_id == 0

        assert isinstance(new_bus_obj.dyna_flow_task_type_id, int)
        assert isinstance(
    ...
    @pytest.mark.asyncio
    async def test_load_with_dyna_flow_task_type_obj(
        self,
        ...
        dyna_flow_task_type object instance.
        """
        ...
        assert obj_manager.is_equal(
            new_bus_obj.dyna_flow_task_type, new_obj) is True

    @pytest.mark.asyncio
    async def test_load_with_dyna_flow_task_type_id(
        self,
        obj_manager: DynaFlowTaskTypeManager,
        new_bus_obj: DynaFlowTaskTypeBusObj,
        new_obj: DynaFlowTaskType
        ...
        new_obj_dyna_flow_task_type_id = \
    ...
    @pytest.mark.asyncio
    async def test_load_with_dyna_flow_task_type_code(
        self,
        obj_manager: DynaFlowTaskTypeManager,
        new_bus_obj: DynaFlowTaskTypeBusObj,
        new_obj: DynaFlowTaskType
    ...
    @pytest.mark.asyncio
    async def test_load_with_dyna_flow_task_type_json(
        self,
        obj_manager: DynaFlowTaskTypeManager,
        new_bus_obj: DynaFlowTaskTypeBusObj,
        new_obj: DynaFlowTaskType
    ...
    @pytest.mark.asyncio
    async def test_load_with_dyna_flow_task_type_dict(
        self,
        obj_manager: DynaFlowTaskTypeManager,
        new_bus_obj: DynaFlowTaskTypeBusObj,
        new_obj: DynaFlowTaskType
        ...
        """
        Test case for loading data from a
        dyna_flow_task_type dictionary.
        """

        logger.info("test_load_with_dyna_flow_task_type_dict 1")

        dyna_flow_task_type_dict = \
            obj_manager.to_dict(
                new_obj)

        logger.info(dyna_flow_task_type_dict)

        await new_bus_obj.load_from_dict(
            dyna_flow_task_type_dict)

        assert obj_manager.is_equal(
            new_bus_obj.dyna_flow_task_type,
            new_obj) is True

    @pytest.mark.asyncio
    async def test_get_nonexistent_dyna_flow_task_type(
        self,
        new_bus_obj: DynaFlowTaskTypeBusObj
    ):
        """
        ...
        # dyna_flow_task_type raises an exception
    ...
    @pytest.mark.asyncio
    async def test_update_dyna_flow_task_type(
        self,
        obj_manager: DynaFlowTaskTypeManager,
        new_bus_obj: DynaFlowTaskTypeBusObj,
        new_obj: DynaFlowTaskType
        ...
        """
        Test case for updating a dyna_flow_task_type's data.
        """
        # Test updating a dyna_flow_task_type's data

        new_obj_dyna_flow_task_type_id_value = \
            new_obj.dyna_flow_task_type_id
    ...
    @pytest.mark.asyncio
    async def test_delete_dyna_flow_task_type(
        self,
        obj_manager: DynaFlowTaskTypeManager,
        new_bus_obj: DynaFlowTaskTypeBusObj,
        new_obj: DynaFlowTaskType
        ...
        assert new_bus_obj.dyna_flow_task_type is not None
        ...
        assert new_bus_obj.dyna_flow_task_type_id is not None
    ...
    async def test_refresh(
        ...
        """
        Test case for refreshing the dyna_flow_task_type data.
        """
        with patch(
            BUSINESS_DYNA_FLOW_TASK_TYPE_BASE_MANAGER_PATCH,
            autospec=True
            ...
            mock_obj_manager_instance.refresh =\
                AsyncMock(return_value=dyna_flow_task_type)
            ...
            mock_obj_manager_instance.refresh \
                .assert_called_once_with(dyna_flow_task_type)

    def test_is_valid(
            self, mock_sess_base_bus_obj):
        """
        Test case for checking if the dyna_flow_task_type data is valid.
        """
        assert mock_sess_base_bus_obj.is_valid() is True

        mock_sess_base_bus_obj.dyna_flow_task_type = None
        assert mock_sess_base_bus_obj.is_valid() is False

    def test_to_dict(
            self, mock_sess_base_bus_obj):
        """
        Test case for converting the dyna_flow_task_type
        ...
        with patch(
            ...
            dyna_flow_task_type_dict = mock_sess_base_bus_obj.to_dict()
            assert dyna_flow_task_type_dict == {"key": "value"}
    ...
    def test_to_json(
            self, mock_sess_base_bus_obj):
        """
        Test case for converting the dyna_flow_task_type data to JSON.
        """
        with patch(
            BUSINESS_DYNA_FLOW_TASK_TYPE_BASE_MANAGER_PATCH,
            autospec=True
            ...
            dyna_flow_task_type_json = mock_sess_base_bus_obj.to_json()
            assert dyna_flow_task_type_json == '{"key": "value"}'
            mock_obj_manager_instance.to_json.assert_called_once_with(
                mock_sess_base_bus_obj.dyna_flow_task_type)

    def test_get_obj(
            self, mock_sess_base_bus_obj, dyna_flow_task_type):
        """
        Test case for getting the dyna_flow_task_type object.
        """
        assert mock_sess_base_bus_obj.get_obj() == dyna_flow_task_type
    ...
    def test_get_object_name(
        ...
        assert mock_sess_base_bus_obj \
            .get_object_name() == "dyna_flow_task_type"

    def test_get_id(
            self, mock_sess_base_bus_obj, dyna_flow_task_type):
        """
        Test case for getting the dyna_flow_task_type ID.
        """
        dyna_flow_task_type.dyna_flow_task_type_id = 1
        assert mock_sess_base_bus_obj.get_id() == 1

    def test_dyna_flow_task_type_id(
            self, mock_sess_base_bus_obj, dyna_flow_task_type):
        """
        Test case for the dyna_flow_task_type_id property.
        """
        dyna_flow_task_type.dyna_flow_task_type_id = 1
        assert mock_sess_base_bus_obj.dyna_flow_task_type_id == 1
    ...
    def test_code(
        ...
        dyna_flow_task_type.code = test_uuid
    ...
    def test_last_change_code(
        ...
        attribute in the DynaFlowTaskTypeBaseBusiness class.

        Args:
            mock_sess_base_bus_obj (DynaFlowTaskTypeBaseBusiness):
                An instance of the
                DynaFlowTaskTypeBaseBusiness class.
        ...
        Returns:
            None
        """
        dyna_flow_task_type.last_change_code = 123
    ...
    def test_insert_user_id(
        ...
        """
        test_uuid = uuid.uuid4()
        dyna_flow_task_type.insert_user_id = test_uuid
    ...
    def test_description(
        ...
        """
        dyna_flow_task_type.description = \
            "Vanilla"
        assert mock_sess_base_bus_obj \
            .description == "Vanilla"
    ...
    def test_display_order(
        ...
        """
        dyna_flow_task_type.display_order = 1
        assert mock_sess_base_bus_obj \
            .display_order == 1
    ...
    def test_is_active(
        ...
        is_active property.
        """
        dyna_flow_task_type.is_active = True
        assert mock_sess_base_bus_obj \
            .is_active is True
    ...
    def test_lookup_enum_name(
        ...
        """
        dyna_flow_task_type.lookup_enum_name = \
            "Vanilla"
        assert mock_sess_base_bus_obj \
    ...
    def test_max_retry_count(
        ...
        """
        dyna_flow_task_type.max_retry_count = 1
        assert mock_sess_base_bus_obj \
            .max_retry_count == 1
    ...
    def test_insert_utc_date_time(
        ...
        dyna_flow_task_type.insert_utc_date_time = test_datetime
        assert mock_sess_base_bus_obj \
    ...
    def test_last_update_utc_date_time(
        ...
        """
        test_datetime = datetime.now(timezone.utc)
        dyna_flow_task_type.last_update_utc_date_time = test_datetime
        assert mock_sess_base_bus_obj \
