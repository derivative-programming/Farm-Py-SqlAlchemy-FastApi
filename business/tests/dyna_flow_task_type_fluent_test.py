# business/tests/dyna_flow_task_type_fluent_test.py  # pylint: disable=duplicate-code # noqa: E501
...
import pytest
from business.dyna_flow_task_type_fluent import \
    DynaFlowTaskTypeFluentBusObj
from helpers.session_context import SessionContext


class MockDynaFlowTaskTypeBaseBusObj:
    """
    ...
    def __init__(self):
        ...
        self.name = None
        self.pac_id = None
class TestDynaFlowTaskTypeFluentBusObj:
    """
    Unit tests for the
    DynaFlowTaskTypeFluentBusObj class.
    """
    ...
    def new_fluent_bus_obj(self, session):
        """
        Return a DynaFlowTaskTypeFluentBusObj
        object.
        """
        session_context = SessionContext({}, session=session)
        return DynaFlowTaskTypeFluentBusObj(
            session_context)
    # description
