# business/tests/dyna_flow_type_schedule_test.py  # pylint: disable=duplicate-code # noqa: E501
...
import models
import pytest
from business.dyna_flow_type_schedule import DynaFlowTypeScheduleBusObj
...
class TestDynaFlowTypeScheduleBusObj:
    ...
    async def test_to_bus_obj_list(
        ...
        with patch(
            ...
            for bus_obj, dyna_flow_type_schedule in \
