# business/tests/conftest.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-argument
# pylint: disable=redefined-outer-name

"""
This module contains fixtures and configurations
for testing the business module.
...
async def session(engine) -> AsyncSession:  # type: ignore
    ...
    Returns:
        sqlalchemy.ext.asyncio.AsyncSession:
            The async session for the database.
    """
