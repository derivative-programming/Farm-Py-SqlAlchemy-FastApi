...
class TestCustomerBusObj:
    ...
    async def test_create_customer(
        ...
        assert customer_bus_obj.email == "" or isinstance(
            customer_bus_obj.email, str)
        assert isinstance(customer_bus_obj.email_confirmed_utc_date_time, datetime)
        assert customer_bus_obj.first_name == "" or isinstance(
            customer_bus_obj.first_name, str)
        ...
        assert customer_bus_obj.last_name == "" or isinstance(
            customer_bus_obj.last_name, str)
        assert customer_bus_obj.password == "" or isinstance(
            customer_bus_obj.password, str)
        assert customer_bus_obj.phone == "" or isinstance(
            customer_bus_obj.phone, str)
        assert customer_bus_obj.province == "" or isinstance(
            customer_bus_obj.province, str)
        ...
        assert customer_bus_obj.zip == "" or isinstance(
            customer_bus_obj.zip, str)
    @pytest.mark.asyncio
