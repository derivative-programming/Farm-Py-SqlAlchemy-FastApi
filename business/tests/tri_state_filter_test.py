...
class TestTriStateFilterBusObj:
    ...
    async def test_create_tri_state_filter(
        ...
        assert tri_state_filter_bus_obj.lookup_enum_name == "" or isinstance(
            tri_state_filter_bus_obj.lookup_enum_name, str)
        assert tri_state_filter_bus_obj.name == "" or isinstance(
            tri_state_filter_bus_obj.name, str)
