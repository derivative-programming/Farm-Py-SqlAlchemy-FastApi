# business/tests/dyna_flow_task_type_test.py  # pylint: disable=duplicate-code # noqa: E501
...
import models
import pytest
from business.dyna_flow_task_type import DynaFlowTaskTypeBusObj
...
class TestDynaFlowTaskTypeBusObj:
    ...
    async def test_to_bus_obj_list(
        ...
        with patch(
            ...
            for bus_obj, dyna_flow_task_type in \
