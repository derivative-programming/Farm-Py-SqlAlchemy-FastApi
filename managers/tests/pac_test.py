...
async def test_get_by_id(pac_manager):
    ...
    fetched_pac = await pac_manager.get_by_id(added_pac.pac_id)
...
async def test_update(pac_manager):
    ...
    await pac_manager.update(added_pac.pac_id, code=new_code)
...
async def test_delete(pac_manager):
    ...
    await pac_manager.delete(added_pac.pac_id)
    fetched_pac = await pac_manager.get_by_id(added_pac.pac_id)
