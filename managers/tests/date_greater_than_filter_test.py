...
async def test_add(date_greater_than_filter_manager):
    ...
    assert added_date_greater_than_filter.id
@pytest.mark.asyncio
async def test_get_by_id(date_greater_than_filter_manager):
    date_greater_than_filter_data = factory.build(dict, FACTORY_CLASS=DateGreaterThanFilterFactory)
    added_date_greater_than_filter = await date_greater_than_filter_manager.add(**date_greater_than_filter_data)
    fetched_date_greater_than_filter = await date_greater_than_filter_manager.get_by_id(added_date_greater_than_filter.id)
    assert fetched_date_greater_than_filter.id == added_date_greater_than_filter.id
@pytest.mark.asyncio
...
async def test_update(date_greater_than_filter_manager):
    ...
    await date_greater_than_filter_manager.update(added_date_greater_than_filter.id, code=new_code)
    fetched_date_greater_than_filter = await date_greater_than_filter_manager.get_by_id(added_date_greater_than_filter.id)
...
async def test_delete(date_greater_than_filter_manager):
    date_greater_than_filter_data = factory.build(dict, FACTORY_CLASS=DateGreaterThanFilterFactory)
    added_date_greater_than_filter = await date_greater_than_filter_manager.add(**date_greater_than_filter_data)
    await date_greater_than_filter_manager.delete(added_date_greater_than_filter.id)
    fetched_date_greater_than_filter = await date_greater_than_filter_manager.get_by_id(added_date_greater_than_filter.id)
