...
async def test_get_by_id(org_api_key_manager):
    ...
    fetched_org_api_key = await org_api_key_manager.get_by_id(added_org_api_key.org_api_key_id)
...
async def test_update(org_api_key_manager):
    ...
    await org_api_key_manager.update(added_org_api_key.org_api_key_id, code=new_code)
...
async def test_delete(org_api_key_manager):
    ...
    await org_api_key_manager.delete(added_org_api_key.org_api_key_id)
    fetched_org_api_key = await org_api_key_manager.get_by_id(added_org_api_key.org_api_key_id)
