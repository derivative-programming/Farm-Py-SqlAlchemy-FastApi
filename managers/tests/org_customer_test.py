...
class TestOrgCustomerManager:
    ...
    async def test_from_json(
        ...
        It creates a org_customer using the `OrgCustomerFactory`
        ...
        org_customer is an instance of the `OrgCustomer` class and has
    ...
    async def test_from_dict(
        ...
        a dictionary representation of a org_customer object.
        Args:
    ...
    async def test_add_bulk(
        ...
        2. Call the `add_bulk` method of the
            `org_customer_manager` instance, passing in the generated org_customer data.
        3. Verify that the number of org_customers returned is
        ...
        5. Verify that the fetched org_customer is an instance of the
            `OrgCustomer` class.
        6. Verify that the insert_user_id and
            last_update_user_id of the fetched org_customer match the
            customer code of the session context.
        7. Verify that the org_customer_id of the fetched
            org_customer matches the org_customer_id of the updated org_customer.
        """
        org_customers_data = [
    ...
    async def test_update_bulk_success(
        ...
        It creates two org_customer instances, updates their codes
    ...
    async def test_update_bulk_org_customer_not_found(
        ...
        1. Defines a list of org_customer updates, where each update
        ...
        throws an exception when a org_customer is not found.
        """
        # Update org_customers
    ...
    async def test_delete_bulk_success(
        ...
        from the database.
        Steps:
        1. Create two org_customer objects using the OrgCustomerFactory.
        2. Delete the org_customers using the delete_bulk method
    ...
    async def test_delete_bulk_org_customers_not_found(
        ...
        2. Assert that the created org_customer is an instance of the
            OrgCustomer class.
    ...
    async def test_delete_bulk_empty_list(
        ...
        Args:
            org_customer_manager (OrgCustomerManager): The instance of the
                OrgCustomerManager class.
        Returns:
            None
        Raises:
    ...
    async def test_count_basic_functionality(
        ...
        This test case creates 5 org_customer objects using the
        OrgCustomerFactory and checks if the count method
        returns the correct count of org_customers.
        Steps:
        1. Create 5 org_customer objects using the OrgCustomerFactory.
    ...
    async def test_refresh_nonexistent_org_customer(
        ...
        Args:
            ...
            session (AsyncSession): The instance of the AsyncSession class.
        Raises:
            Exception: If the org_customer refresh operation raises an exception.
        Returns:
            None
        """
    ...
    async def test_exists_with_existing_org_customer(
        ...
        """
        Test case to check if a org_customer exists using the manager function.
        Args:
            org_customer_manager (OrgCustomerManager): The org_customer manager instance.
            session (AsyncSession): The async session object.
        Returns:
            None
        """
    ...
    async def test_exists_with_nonexistent_org_customer(
        ...
        Returns:
            bool: True if the org_customer exists, False otherwise.
        """
        non_existent_id = 999
...
# endset
    ...
    async def test_get_by_customer_id_existing(
        ...
        when a org_customer with a specific customer_id exists.
        Steps:
        1. Create a org_customer using the OrgCustomerFactory.
        2. Fetch the org_customer using the
            `get_by_customer_id` method of the org_customer_manager.
        3. Assert that the fetched org_customers list has a length of 1.
        4. Assert that the first element in the fetched
            org_customers list is an instance of the OrgCustomer class.
        ...
        6. Execute a select statement to fetch the
            Customer object associated with the customer_id.
        7. Assert that the fetched customer is an instance of the Customer class.
        8. Assert that the customer_code_peek
            of the fetched org_customer matches the code of the fetched customer.
        """
