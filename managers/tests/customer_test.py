...
async def test_get_by_id(customer_manager):
    ...
    fetched_customer = await customer_manager.get_by_id(added_customer.customer_id)
...
async def test_update(customer_manager):
    ...
    await customer_manager.update(added_customer.customer_id, code=new_code)
...
async def test_delete(customer_manager):
    ...
    await customer_manager.delete(added_customer.customer_id)
    fetched_customer = await customer_manager.get_by_id(added_customer.customer_id)
