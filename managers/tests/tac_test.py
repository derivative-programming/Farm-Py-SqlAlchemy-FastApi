...
async def test_get_by_id(tac_manager):
    ...
    fetched_tac = await tac_manager.get_by_id(added_tac.tac_id)
...
async def test_update(tac_manager):
    ...
    await tac_manager.update(added_tac.tac_id, code=new_code)
...
async def test_delete(tac_manager):
    ...
    await tac_manager.delete(added_tac.tac_id)
    fetched_tac = await tac_manager.get_by_id(added_tac.tac_id)
