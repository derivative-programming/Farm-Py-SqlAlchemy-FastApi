...
async def test_get_by_id(error_log_manager):
    ...
    fetched_error_log = await error_log_manager.get_by_id(added_error_log.error_log_id)
...
async def test_update(error_log_manager):
    ...
    await error_log_manager.update(added_error_log.error_log_id, code=new_code)
...
async def test_delete(error_log_manager):
    ...
    await error_log_manager.delete(added_error_log.error_log_id)
    fetched_error_log = await error_log_manager.get_by_id(added_error_log.error_log_id)
