# models/managers/date_greater_than_filter.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module contains the
DateGreaterThanFilterManager class, which is
responsible for managing
date_greater_than_filters in the system.
"""
...
class DateGreaterThanFilterManager:
    """
    The DateGreaterThanFilterManager class
...
##GENTrainingBlock[caseIsLookupObject]End
    ...
    async def build(self, **kwargs) -> DateGreaterThanFilter:
        """
        Builds a new DateGreaterThanFilter
        ...
        """
        logging.info(
            "DateGreaterThanFilterManager.build")
    ...
    async def add(
        ...
        Args:
            date_greater_than_filter (DateGreaterThanFilter): The
                date_greater_than_filter to add.

        Returns:
            DateGreaterThanFilter: The added
                date_greater_than_filter.
        """
        logging.info(
            "DateGreaterThanFilterManager.add")
    ...
    def _build_query(self):
        ...
        """
        logging.info(
            "DateGreaterThanFilterManager._build_query")
    ...
    async def _run_query(
        ...
        date_greater_than_filters from the database.
        ...
        """
        logging.info(
            "DateGreaterThanFilterManager._run_query")
    ...
    def _first_or_none(
        ...
        Returns:
            Optional[DateGreaterThanFilter]: The
    ...
    async def get_by_id(
        self, date_greater_than_filter_id: int
    ) -> Optional[DateGreaterThanFilter]:
        """
        Retrieves a date_greater_than_filter by its ID.

        Args:
            date_greater_than_filter_id (int): The ID of the
                date_greater_than_filter to retrieve.
    ...
    async def get_by_code(
        ...
        """
        Retrieves a date_greater_than_filter
        by its code.
        ...
        Returns:
            Optional[DateGreaterThanFilter]: The retrieved
                date_greater_than_filter, or None if not found.
        """
        logging.info("DateGreaterThanFilterManager.get_by_code %s",
                     code)
    ...
    async def update(
        ...
        """
        Updates a date_greater_than_filter with
        the specified attributes.

        Args:
            date_greater_than_filter (DateGreaterThanFilter): The
                date_greater_than_filter to update.
            **kwargs: The attributes to update.

        Returns:
            Optional[DateGreaterThanFilter]: The updated
                date_greater_than_filter, or None if not found.
    ...
    async def delete(self, date_greater_than_filter_id: int):
        ...
        Args:
            date_greater_than_filter_id (int): The ID of the
                date_greater_than_filter to delete.

        Raises:
            TypeError: If the date_greater_than_filter_id
                is not an integer.
            DateGreaterThanFilterNotFoundError: If the
                date_greater_than_filter with the
    ...
    def to_json(
            self,
            date_greater_than_filter: DateGreaterThanFilter) -> str:
        """
        Serializes a DateGreaterThanFilter object
        to a JSON string.

        Args:
            date_greater_than_filter (DateGreaterThanFilter): The
                date_greater_than_filter to serialize.
        ...
        """
        logging.info(
            "DateGreaterThanFilterManager.to_json")
    ...
    def to_dict(
        ...
        """
        Serializes a DateGreaterThanFilter
        ...
        """
        logging.info(
            "DateGreaterThanFilterManager.to_dict")
        schema = DateGreaterThanFilterSchema()
        date_greater_than_filter_data = schema.dump(date_greater_than_filter)
    ...
    async def from_json(self, json_str: str) -> DateGreaterThanFilter:
        ...
        Returns:
            DateGreaterThanFilter: The deserialized
                DateGreaterThanFilter object.
        """
        logging.info(
            "DateGreaterThanFilterManager.from_json")
        schema = DateGreaterThanFilterSchema()
        ...
        # load or create
        new_date_greater_than_filter = await self.get_by_id(
            date_greater_than_filter_dict["date_greater_than_filter_id"])
    ...
    async def from_dict(
        self, date_greater_than_filter_dict: Dict[str, Any]
    ) -> DateGreaterThanFilter:
        """
        Creates a DateGreaterThanFilter
        instance from a dictionary of attributes.

        Args:
            date_greater_than_filter_dict (Dict[str, Any]): A dictionary
                containing date_greater_than_filter
                attributes.

        Returns:
            DateGreaterThanFilter: A new
                DateGreaterThanFilter instance
                created from the given
                dictionary.
        """
        logging.info(
            "DateGreaterThanFilterManager.from_dict")
        ...
        # load or create
        new_date_greater_than_filter = await self.get_by_id(
            date_greater_than_filter_dict_converted["date_greater_than_filter_id"])
        if new_date_greater_than_filter is None:
            new_date_greater_than_filter = DateGreaterThanFilter(
    ...
    async def add_bulk(
        ...
        """
        Adds multiple date_greater_than_filters
        to the system.

        Args:
            date_greater_than_filters (List[DateGreaterThanFilter]): The list of
                date_greater_than_filters to add.

        Returns:
            List[DateGreaterThanFilter]: The added
                date_greater_than_filters.
        """
        logging.info(
            "DateGreaterThanFilterManager.add_bulk")
        for list_item in date_greater_than_filters:
            date_greater_than_filter_id = \
                list_item.date_greater_than_filter_id
            code = list_item.code
            if list_item.date_greater_than_filter_id is not None and \
                    list_item.date_greater_than_filter_id > 0:
                raise ValueError(
                    "DateGreaterThanFilter is already added"
                    f": {str(code)} {str(date_greater_than_filter_id)}"
                )
    ...
    async def update_bulk(
        ...
        """
        Update multiple date_greater_than_filters
        ...
        logging.info(
            "DateGreaterThanFilterManager.update_bulk end")
    ...
    async def delete_bulk(
        ...
        """
        Delete multiple date_greater_than_filters
        by their IDs.
        """
        logging.info(
            "DateGreaterThanFilterManager.delete_bulk")
    ...
    async def count(self) -> int:
        ...
        """
        logging.info(
            "DateGreaterThanFilterManager.count")
    ...
    async def refresh(
        ...
        date_greater_than_filter instance
        from the database.
        """

        logging.info(
            "DateGreaterThanFilterManager.refresh")
    ...
    async def exists(self, date_greater_than_filter_id: int) -> bool:
        """
        Check if a date_greater_than_filter
    ...
    def is_equal(
        ...
        """
        Check if two DateGreaterThanFilter
        objects are equal.

        Args:
            date_greater_than_filter1 (DateGreaterThanFilter): The first
                DateGreaterThanFilter object.
            date_greater_than_filter2 (DateGreaterThanFilter): The second
                DateGreaterThanFilter object.

        Returns:
            bool: True if the two DateGreaterThanFilter
                objects are equal, False otherwise.

        Raises:
            TypeError: If either date_greater_than_filter1
                or date_greater_than_filter2
        ...
        if not isinstance(date_greater_than_filter1,
                          DateGreaterThanFilter):
            raise TypeError("The date_greater_than_filter1 must be an "
                            "DateGreaterThanFilter instance.")

        if not isinstance(date_greater_than_filter2,
                          DateGreaterThanFilter):
            raise TypeError("The date_greater_than_filter2 must be an "
                            "DateGreaterThanFilter instance.")
    ...
    async def get_by_pac_id(
            self,
            pac_id: int) -> List[DateGreaterThanFilter]:
        """
        Retrieve a list of date_greater_than_filters by
        pac ID.
        ...
        Returns:
            List[DateGreaterThanFilter]: A list of
                date_greater_than_filters associated
                with the specified pac ID.
        """

        logging.info(
            "DateGreaterThanFilterManager.get_by_pac_id")
