...
class RoleManager:
    ...
    async def get_by_code(
        ...
        Returns:
            Optional[Role]: The retrieved
                role, or None if not found.
        """
        logging.info("RoleManager.get_by_code %s",
                     code)
    ...
    async def delete(self, role_id: int):
        ...
        Raises:
            TypeError: If the role_id
                is not an integer.
            RoleNotFoundError: If the
                role with the
                specified ID is not found.
        """
        logging.info(
            "RoleManager.delete %s",
            role_id)
        if not isinstance(role_id, int):
            raise TypeError(
    ...
    async def from_json(self, json_str: str) -> Role:
        """
