...
from models.serialization_schema.org_api_key import \
    OrgApiKeySchema
...
class OrgApiKeyManager:
    ...
    async def get_by_id(
        ...
        """
        logging.info(
            "OrgApiKeyManager.get_by_id "
            "start org_api_key_id: %s",
            str(org_api_key_id))
    ...
    async def delete_bulk(
            self, org_api_key_ids: List[int]) -> bool:
        """
