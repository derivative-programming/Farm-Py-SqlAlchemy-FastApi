...
import models.constants.role as role_constants
...
class Role(Base):
    ...
    #TODO add comment
    """
    __tablename__ = 'farm_' + snake_case('Role')
    role_id = Column(
        'role_id',
        Integer,
        primary_key=True,
    ...
    description = Column(
        ...
        default="",
        index=role_constants.description_calculatedIsDBColumnIndexed,
        nullable=True)
    display_order = Column(
        'display_order',
        Integer,
        default=0,
        index=role_constants.display_order_calculatedIsDBColumnIndexed,
        nullable=True)
    is_active = Column(
        'is_active',
        Boolean,
        default=False,
        index=role_constants.is_active_calculatedIsDBColumnIndexed,
        nullable=True)
    lookup_enum_name = Column(
        ...
        default="",
        index=role_constants.lookup_enum_name_calculatedIsDBColumnIndexed,
        nullable=True)
    name = Column(
        'name',
        ...
        default="",
        index=role_constants.name_calculatedIsDBColumnIndexed,
        nullable=True)
    pac_id = Column('pac_id',
                     Integer,
                     ForeignKey('farm_' + snake_case('Pac') + '.pac_id'),
                     index=role_constants.pac_id_calculatedIsDBColumnIndexed,
                     nullable=True)
...
# Index('index_code', Role.code)
# Index('farm_role_index_pac_id', Role.pac_id)  # PacID
