...
import pytz
from models import DateGreaterThanFilter,DateGreaterThanFilterSchema
...
class DateGreaterThanFilterFactory(factory.Factory):
    ...
    @classmethod
    def _build(cls, model_class, session, *args, **kwargs) -> DateGreaterThanFilter:
    ...
    def _create(cls, model_class, session, *args, **kwargs) -> DateGreaterThanFilter:
        ...
        return obj
    @classmethod
    async def create_async(cls, model_class, session, *args, **kwargs) -> DateGreaterThanFilter:
        pac_id_pac_instance = PacFactory.create(session=session)  #PacID
        ...
        return obj
    @classmethod
    async def build_async(cls, model_class, session, *args, **kwargs) -> DateGreaterThanFilter:
        pac_id_pac_instance = PacFactory.create(session=session)  #PacID
