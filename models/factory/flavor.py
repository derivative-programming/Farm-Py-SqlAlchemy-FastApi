...
class FlavorFactory(factory.Factory):
    ...
    @classmethod
    def _build(cls, model_class, session, *args, **kwargs) -> Flavor:
    ...
    def _create(cls, model_class, session, *args, **kwargs) -> Flavor:
        ...
        return obj
    @classmethod
    async def create_async(cls, model_class, session, *args, **kwargs) -> Flavor:
        pac_id_pac_instance = PacFactory.create(session=session)  #PacID
        ...
        return obj
    @classmethod
    async def build_async(cls, model_class, session, *args, **kwargs) -> Flavor:
        pac_id_pac_instance = PacFactory.create(session=session)  #PacID
