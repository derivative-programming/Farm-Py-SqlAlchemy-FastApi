# models/factory/tests/tri_state_filter_async_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestTriStateFilterFactoryAsync:
    ...
    async def test_unique_code_constraint(self, session):
        ...
        instances using
        the TriStateFilterFactoryand assigns
        the same code to both tri_state_filters.
    ...
    async def test_fields_default(self):
        ...
        of various fields in the TriStateFilter
