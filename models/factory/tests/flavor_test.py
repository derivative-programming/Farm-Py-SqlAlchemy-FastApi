# models/factory/tests/flavor_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestFlavorFactory:
    ...
    def test_flavor_creation(self, session):
        ...
        """
        new_obj = FlavorFactory.create(
            session=session)
        assert new_obj.flavor_id is not None
    ...
    def test_last_change_code_default_on_build(self, session):
        ...
        """
        new_obj: Flavor = FlavorFactory.build(
            session=session)
    ...
    def test_last_change_code_default_on_creation(self, session):
        ...
        """
        new_obj: Flavor = FlavorFactory.create(
            session=session)
