# models/factory/tests/error_log_async_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestErrorLogFactoryAsync:
    ...
    async def test_unique_code_constraint(self, session):
        ...
        instances using
        the ErrorLogFactoryand assigns
        the same code to both error_logs.
    ...
    async def test_fields_default(self):
        ...
        of various fields in the ErrorLog
