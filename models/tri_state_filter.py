...
class TriStateFilter(Base):
    ...
    tri_state_filter_id = Column(Integer, primary_key=True, autoincrement=True)
    ...
    state_int_value = Column(Integer, default=0, nullable=True)
    ...
    def __init__(self, **kwargs):
        ...
        self.state_int_value = kwargs.get('state_int_value', 0)
