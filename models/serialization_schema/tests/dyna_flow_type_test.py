# models/serialization_schema/tests/dyna_flow_type_test.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=redefined-outer-name, too-many-public-methods
# pylint: disable=unused-import

"""
This module contains tests for the
DynaFlowType serialization schema.

The DynaFlowType serialization schema
is responsible for serializing and deserializing
DynaFlowType instances. It ensures that the
...
and deserialization of DynaFlowType
instances using the DynaFlowTypeSchema
class. They verify
that the serialized data
matches the expected format and that the
deserialized data can be used to
reconstruct a DynaFlowType instance.

The DynaFlowTypeSchema class
is used to define
the serialization and deserialization
rules for DynaFlowType instances. It
...
be converted back to a DynaFlowType
instance.
...
from models.serialization_schema import DynaFlowTypeSchema
...
def new_obj(
    ...
    """
    Fixture to create and return a DynaFlowType
    instance using the
    DynaFlowTypeFactory.
    ...
    Returns:
        DynaFlowType: A newly created
            DynaFlowType instance.
    """

    return DynaFlowTypeFactory.create(session=session)


class TestDynaFlowTypeSchema:
    """
    Tests for the DynaFlowType
    serialization schema.
    """

    # Sample data for a DynaFlowType
    # instance
    sample_data = {
        "dyna_flow_type_id": 1,
        "code":
...
# endset  # noqa: E122
    ...
    def test_dyna_flow_type_serialization(
        self,
        new_obj: DynaFlowType
    ):
        """
        Test the serialization of a
        DynaFlowType instance using
        DynaFlowTypeSchema.

        Args:
            dyna_flow_type (DynaFlowType):
                A DynaFlowType instance to serialize.
        """

        schema = DynaFlowTypeSchema()
        dyna_flow_type_data = schema.dump(new_obj)

        assert isinstance(dyna_flow_type_data, dict)

        result = dyna_flow_type_data
    ...
    def test_dyna_flow_type_deserialization(
        self,
        new_obj: DynaFlowType
    ):
        """
        ...
        Args:
            dyna_flow_type (DynaFlowType): The
                DynaFlowType object to be deserialized.
    ...
    def test_from_json(self):
        """
        Test the `from_json` method of the DynaFlowTypeSchema class.
        ...
        and then loads the dictionary to a DynaFlowType
        ...
        dyna_flow_type_schema = DynaFlowTypeSchema()
        ...
        deserialized_data = dyna_flow_type_schema.load(json_data)
        ...
        assert isinstance(new_dyna_flow_type,
                          DynaFlowType)
    ...
    def test_to_json(
        ...
        DynaFlowType instance to JSON.

        Args:
            dyna_flow_type (DynaFlowType): The
            DynaFlowType instance to convert.
        ...
        # Convert the DynaFlowType instance
        # to JSON using the schema
        dyna_flow_type_schema = DynaFlowTypeSchema()
        dyna_flow_type_dict = dyna_flow_type_schema.dump(
            new_obj)

        # Convert the dyna_flow_type_dict to JSON string
        dyna_flow_type_json = json.dumps(
            dyna_flow_type_dict)
