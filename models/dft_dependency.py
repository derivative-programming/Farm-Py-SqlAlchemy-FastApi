# models/dft_dependency.py  # pylint: disable=duplicate-code
...
class DFTDependency(Base):
    ...
    def dependency_df_task_id(self) -> int:
        """
        Returns the value of the '_dependency_df_task_id' attribute of the object.
        If the attribute is not set, it returns 0.

        :return: The value of the '_dependency_df_task_id' attribute or 0 if not set.
        :rtype: int
        """
