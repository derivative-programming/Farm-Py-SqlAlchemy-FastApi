# flows/default/pac_process_all_dyna_flow_type_schedule_flow.py  # pylint: disable=duplicate-code
...
from flows.base.pac_process_all_dyna_flow_type_schedule_flow import BaseFlowPacProcessAllDynaFlowTypeScheduleFlow
