# flows/constants/pac_user_date_greater_than_filter_list_init_report.py  # pylint: disable=duplicate-code # noqa: E501

"""
    This module contains configuration constants
    used in the pac_user_date_greater_than_filter_list_init_report flow.
"""
