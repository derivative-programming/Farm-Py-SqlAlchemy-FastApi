# flows/constants/land_user_plant_multi_select_to_not_editable.py  # pylint: disable=duplicate-code # noqa: E501

"""
    This module contains configuration constants
    used in the land_user_plant_multi_select_to_not_editable flow.
"""
