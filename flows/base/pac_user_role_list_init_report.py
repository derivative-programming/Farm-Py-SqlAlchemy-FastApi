...
of the BaseFlow Pac User Role List Init Report class
"""
import uuid
...
class BaseFlowPacUserRoleListInitReport(BaseFlow):
    """
    Base class for PacUserRoleListInitReport flow. Contains some validaiton and security check logic
    """
    def __init__(self, session_context: SessionContext):
        """
        Initializes a new instance of the BaseFlowPacUserRoleListInitReport class.
        Args:
