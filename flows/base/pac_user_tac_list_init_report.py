# flows/base/pac_user_tac_list_init_report.py  # pylint: disable=duplicate-code # noqa: E501
...
import flows.constants.pac_user_tac_list_init_report \
    as FlowConstants
...
class BaseFlowPacUserTacListInitReport(BaseFlow):  # pylint: disable=too-few-public-methods
    """
    Base class for PacUserTacListInitReport
    flow. Contains
