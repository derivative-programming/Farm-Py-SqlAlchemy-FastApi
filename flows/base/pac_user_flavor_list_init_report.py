# flows/base/pac_user_flavor_list_init_report.py  # pylint: disable=duplicate-code # noqa: E501
...
class BaseFlowPacUserFlavorListInitReport(BaseFlow):  # pylint: disable=too-few-public-methods
    """
    Base class for PacUserFlavorListInitReport
    flow. Contains
