...
of the BaseFlow Tac Register Init Obj WF class
"""
import uuid
...
class BaseFlowTacRegisterInitObjWF(BaseFlow):
    """
    Base class for TacRegisterInitObjWF flow. Contains some validaiton and security check logic
    """
    def __init__(self, session_context: SessionContext):
        """
        Initializes a new instance of the BaseFlowTacRegisterInitObjWF class.
        Args:
