...
import flows.constants.error_log_config_resolve_error_log \
    as FlowConstants
...
class BaseFlowErrorLogConfigResolveErrorLog(BaseFlow):  # pylint: disable=too-few-public-methods
    """
    Base class for ErrorLogConfigResolveErrorLog
    flow. Contains
