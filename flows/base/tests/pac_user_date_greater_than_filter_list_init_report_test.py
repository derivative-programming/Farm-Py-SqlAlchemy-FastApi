# flows/base/tests/pac_user_date_greater_than_filter_list_init_report_test.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=protected-access, too-many-public-methods
# pylint: disable=unused-import
"""
This module contains the unit tests for the
`BaseFlowPacUserDateGreaterThanFilterListInitReport` class.
"""
...
class TestBaseFlowPacUserDateGreaterThanFilterListInitReport():
    ...
    async def test_process_validation_rules(self, session):
        ...
        flow = BaseFlowPacUserDateGreaterThanFilterListInitReport(
            session_context)
        pac = await \
...
# endset  # noqa: E122
    ...
    async def test_process_security_rules(self, session):
        ...
        object, and a
        BaseFlowPacUserDateGreaterThanFilterListInitReport object.
