...
"""
This module contains the unit tests for the `BaseFlowPlantUserDetailsInitReport` class.
"""
...
class TestBaseFlowPlantUserDetailsInitReport():
    """
    This class contains unit tests for the `BaseFlowPlantUserDetailsInitReport` class.
    """
    @pytest.mark.asyncio
...
# endset
    ...
    async def test_process_security_rules(self, session):
        """
        Test the process_security_rules method of BaseFlowPlantUserDetailsInitReport.
        ...
        object, and a BaseFlowPlantUserDetailsInitReport object.
