import unittest
import uuid
from flows.base import BaseFlowPlantUserPropertyRandomUpdate
...
class BaseFlowPlantUserPropertyRandomUpdateTestCase(unittest.TestCase):
    def setUp(self):
        CurrentRuntime.initialize()
        session_context = SessionContext(dict())
        self.flow = BaseFlowPlantUserPropertyRandomUpdate(session_context)
