import unittest
import uuid
from flows.base import BaseFlowPacUserTriStateFilterListInitReport
...
class BaseFlowPacUserTriStateFilterListInitReportTestCase(unittest.TestCase):
    def setUp(self):
        CurrentRuntime.initialize()
        session_context = SessionContext(dict())
        self.flow = BaseFlowPacUserTriStateFilterListInitReport(session_context)
