# flows/base/tests/pac_user_flavor_list_init_report_test.py  # pylint: disable=duplicate-code # noqa: E501
...
import pytest
import flows.constants.pac_user_flavor_list_init_report \
...
class TestBaseFlowPacUserFlavorListInitReport():
    ...
    async def test_process_validation_rules(self, session):
        ...
        flow = BaseFlowPacUserFlavorListInitReport(
            session_context)
        pac = await \
...
# endset  # noqa: E122
    ...
    async def test_process_security_rules(self, session):
        ...
        object, and a
        BaseFlowPacUserFlavorListInitReport object.
