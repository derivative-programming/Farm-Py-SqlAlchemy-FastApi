# flows/base/tests/land_plant_list_init_report_test.py  # pylint: disable=duplicate-code # noqa: E501
...
import pytest
import flows.constants.land_plant_list_init_report \
...
class TestBaseFlowLandPlantListInitReport():
    ...
    async def test_process_validation_rules(self, session):
        ...
        flow = BaseFlowLandPlantListInitReport(
            session_context)
        land = await \
...
# endset  # noqa: E122
    ...
    async def test_process_security_rules(self, session):
        ...
        object, and a
        BaseFlowLandPlantListInitReport object.
