# flows/base/tests/pac_user_test_async_file_download_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestBaseFlowPacUserTestAsyncFileDownload():
    """
    ...
    async def test_process_validation_rules(self, session):
        ...
        of the BaseFlowPacUserTestAsyncFileDownload class.
        ...
        flow = BaseFlowPacUserTestAsyncFileDownload(
            session_context)
        pac = await \
...
# endset  # noqa: E122
    ...
    async def test_process_security_rules(self, session):
        ...
        object, and a
        BaseFlowPacUserTestAsyncFileDownload object.
