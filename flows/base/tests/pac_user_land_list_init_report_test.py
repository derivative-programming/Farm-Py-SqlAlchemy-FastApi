# flows/base/tests/pac_user_land_list_init_report_test.py  # pylint: disable=duplicate-code # noqa: E501
...
class TestBaseFlowPacUserLandListInitReport():
    ...
    async def test_process_validation_rules(self, session):
        ...
        flow = BaseFlowPacUserLandListInitReport(
            session_context)
        pac = await \
...
# endset  # noqa: E122
    ...
    async def test_process_security_rules(self, session):
        ...
        object, and a
        BaseFlowPacUserLandListInitReport object.
