import unittest
import uuid
from flows.base import BaseFlowPacUserDateGreaterThanFilterListInitReport
...
class BaseFlowPacUserDateGreaterThanFilterListInitReportTestCase(unittest.TestCase):
    def setUp(self):
        CurrentRuntime.initialize()
        session_context = SessionContext(dict())
        self.flow = BaseFlowPacUserDateGreaterThanFilterListInitReport(session_context)
