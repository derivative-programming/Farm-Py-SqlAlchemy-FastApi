# flows/base/tac_login_init_obj_wf.py  # pylint: disable=duplicate-code # noqa: E501
# pylint: disable=unused-import

"""
This module contains the implementation
of the BaseFlow
Tac Login Init Obj WF class
"""
...
import flows.constants.tac_login_init_obj_wf \
    as FlowConstants
...
class BaseFlowTacLoginInitObjWF(BaseFlow):  # pylint: disable=too-few-public-methods
    """
    Base class for TacLoginInitObjWF
    flow. Contains
    ...
    def __init__(self, session_context: SessionContext):
        ...
        BaseFlowTacLoginInitObjWF class.
