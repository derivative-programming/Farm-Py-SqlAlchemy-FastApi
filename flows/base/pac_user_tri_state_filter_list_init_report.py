# flows/base/pac_user_tri_state_filter_list_init_report.py
"""
This module contains the implementation
of the BaseFlow Pac User Tri State Filter List Init Report class
"""
import uuid
...
class BaseFlowPacUserTriStateFilterListInitReport(BaseFlow):
    """
    Base class for PacUserTriStateFilterListInitReport flow. Contains some validaiton and security check logic
    """
