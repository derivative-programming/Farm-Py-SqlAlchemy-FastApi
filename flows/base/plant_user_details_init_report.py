...
class BaseFlowPlantUserDetailsInitReport(BaseFlow):
    """
    Base class for PlantUserDetailsInitReport flow. Contains some validaiton and security check logic
    """
    def __init__(self, session_context: SessionContext):
        """
        Initializes a new instance of the BaseFlowPlantUserDetailsInitReport class.
        Args:
