# flows/base/customer_user_log_out.py  # pylint: disable=duplicate-code # noqa: E501
...
import flows.constants.customer_user_log_out \
    as FlowConstants
...
class BaseFlowCustomerUserLogOut(BaseFlow):  # pylint: disable=too-few-public-methods
    """
    Base class for CustomerUserLogOut
    flow. Contains
